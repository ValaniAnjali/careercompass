...
const Templateselector = ({ selectedTemplate, onChange, onCustomize }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full w-xs max-h-72 overflow-y-auto p-3 mt-2 space-y-3 z-20 bg-white rounded-md border border-gray-200 shadow-sm">
          {/* ===== Templates ===== */}
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-blue-700 hover:bg-blue-50 rounded-md transition"
          >
            <Palette size={14} />
            Customize Resume
          </button>
