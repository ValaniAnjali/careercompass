...
const Templateselector = ({ selectedTemplate, onChange }) => {
    ...
    return (
        <div className='relative'>
            ...
            {
                isOpen && (
                    <div className='absolute top-full w-xs max-h-64 overflow-y-auto p-3 mt-2 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100'>
