...
<div className="flex items-center gap-2 text-sm text-blue-800 bg-blue-400/10  rounded-full px-4 py-1">
        ...
        <Title title='Build Your Resume' description='Our streamlined process helps you create a professional resume in minutes with inteligent AI-powered tools & Features.'/>
