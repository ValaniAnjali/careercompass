  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        {/* Other buttons for interview que/ resource sharing etc..*/}
        <div className='grid grid-cols-2 sm:flex flex-wrap gap-4 mb-6'>
          ...
          <button
            ...
            hover:border-blue-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
              ...
              from-blue-300 to-blue-500 text-white rounded-full' />
          ...
          <button
            ...
            className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center
            rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group
            hover:border-green-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
          ...
          <button
            ...
            hover:border-orange-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
              <FilePenLineIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br 
              from-orange-300 to-orange-500 text-white rounded-full' />
          ...
          <button
            ...
            hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
              <UploadCloud className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br 
